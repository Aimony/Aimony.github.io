import{_ as s,o as a,c as n,a7 as e}from"./chunks/framework.D6IbrqK8.js";const u=JSON.parse('{"title":"Mysql for Windows 安装及初始化","description":"Mysql for Windows 安装及初始化。","frontmatter":{"description":"Mysql for Windows 安装及初始化。","categories":["教程分享"],"tags":["mysql","windows"],"sticky":2},"headers":[],"relativePath":"training/software/mysql-for-win-install.md","filePath":"training/software/mysql-for-win-install.md","lastUpdated":1728132256000}'),p={name:"training/software/mysql-for-win-install.md"},l=e(`<h1 id="mysql-for-windows-安装及初始化" tabindex="-1">Mysql for Windows 安装及初始化 <a class="header-anchor" href="#mysql-for-windows-安装及初始化" aria-label="Permalink to &quot;Mysql for Windows 安装及初始化&quot;">​</a></h1><h2 id="一、简介" tabindex="-1">一、简介 <a class="header-anchor" href="#一、简介" aria-label="Permalink to &quot;一、简介&quot;">​</a></h2><p>Windows 安装 Mysql 主要还是为了本地调试的方便。8.x 的版本和 5.7 的版本安装过程大差不差，这里以 8.0.35（8.2版本发布前的最新版）举例。</p><h2 id="二、下载安装" tabindex="-1">二、下载安装 <a class="header-anchor" href="#二、下载安装" aria-label="Permalink to &quot;二、下载安装&quot;">​</a></h2><p>Windows 端 Mysql 只需要在 <a href="https://dev.mysql.com/downloads/mysql/" target="_blank" rel="noreferrer">MySQL :: Download MySQL Community Server</a> 页面选择对应版本下载 mysql-xxx-winx64.zip，该压缩包为编译后文件，并非源码， 可以直接运行。</p><p>目录结构如下：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Directory: D:\\Element\\mysql-8.0.35</span></span>
...
<span class="line"><span>Type &#39;help;&#39; or &#39;\\h&#39; for help. Type &#39;\\c&#39; to clear the current input statement.</span></span>
<span class="line"><span></span></span>
<span class="line"><span>mysql&gt;</span></span></code></pre></div><p>登录成功！至此，Mysql For Windows 安装完成。</p><h2 id="五、其他" tabindex="-1">五、其他 <a class="header-anchor" href="#五、其他" aria-label="Permalink to &quot;五、其他&quot;">​</a></h2><h3 id="mysql-服务无法启动" tabindex="-1">Mysql 服务无法启动 <a class="header-anchor" href="#mysql-服务无法启动" aria-label="Permalink to &quot;Mysql 服务无法启动&quot;">​</a></h3><p>Mysql 初始化顺序为先修改配置文件，再初始化，如果先初始化，然后修改了诸如忽略大小写等与现有数据冲突的配置，可能会造成无法启动。</p>`,38),t=[l];function i(o,r,c,d,h,m){return a(),n("div",{"data-pagefind-body":!0},t)}const q=s(p,[["render",i]]);export{u as __pageData,q as default};
